class RecipeIngredientsController < ApplicationController
  def index
    ...
    render({ :template => "recipe_ingredients/index" })
  end
  ...
  def show
    ...
    render({ :template => "recipe_ingredients/show" })
  end

  def create
    the_recipe_ingredient = RecipeIngredient.new
    the_recipe_ingredient.recipe_id = params.fetch("query_recipe_id")
    the_recipe_ingredient.ingredient_id = params.fetch("query_ingredient_id")
    the_recipe_ingredient.unit_id = params.fetch("query_unit_id")
    the_recipe_ingredient.quantity_id = params.fetch("query_quantity_id")
